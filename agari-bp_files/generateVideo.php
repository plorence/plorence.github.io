...
if (typeof parent.videojs == 'undefined') {
	...
	videoJSStyle.setAttribute("href", "//cdn2.editmysite.com/css/videojs/video.4.3.css?buildTime=1706314831");
	...
	videoJSScript.setAttribute("src", "//www.weebly.com/weebly/libraries/videojs/video.4.3.js?buildTime=1706314831");
...
function firstVideo() {
	parent.videojs.options.flash.swf = '//www.weebly.com/weebly/libraries/videojs/video-js.swf?buildTime=1706314831';
	plantVideo();
}
...
function plantVideo() {
	var currVideo = jQuery(
		'<div class="video-js-holder">'
			+ '<video id="video-913376001407160983" poster="/uploads/b/121477739-791686966519154943/bp.animated.2_164.jpg" class="video-js vjs-big-play-centered" style="display: none;">'
				+ '<source src="/uploads/b/121477739-791686966519154943/bp.animated.2_164.mp4" type="video/mp4" />'
			+ '</video>'
		+ '</div>'
	);
	parent.document.getElementById('wsite-video-container-913376001407160983').appendChild(currVideo.get(0));
	...
	var videoPlayer = videojs("video-913376001407160983", {
		"controls": true,
		"autoplay": false,
		'techOrder': ['html5','flash'],
		"preload": "none",
		"poster": "/uploads/b/121477739-791686966519154943/bp.animated.2_164.jpg",
		"width": 501,
		"height": 282
	}, function(){
		...
		if (ie8Mode) {
			...
			currVideo.find('.vjs-poster').css({
				'background-image': 'url("/uploads/b/121477739-791686966519154943/bp.animated.2_164.jpg")',
