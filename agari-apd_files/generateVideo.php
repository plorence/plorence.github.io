...
function plantVideo() {
	var currVideo = jQuery(
		'<div class="video-js-holder">'
			+ '<video id="video-124693690694816388" poster="/uploads/b/121477739-791686966519154943/ep.animated.3_362.jpg" class="video-js vjs-big-play-centered" style="display: none;">'
				+ '<source src="/uploads/b/121477739-791686966519154943/ep.animated.3_362.mp4" type="video/mp4" />'
			+ '</video>'
		+ '</div>'
	);
	parent.document.getElementById('wsite-video-container-124693690694816388').appendChild(currVideo.get(0));
	...
	var videoPlayer = videojs("video-124693690694816388", {
		"controls": true,
		"autoplay": false,
		'techOrder': ['html5','flash'],
		"preload": "none",
		"poster": "/uploads/b/121477739-791686966519154943/ep.animated.3_362.jpg",
		"width": 501,
		"height": 282
	}, function(){
		...
		if (ie8Mode) {
			...
			currVideo.find('.vjs-poster').css({
				'background-image': 'url("/uploads/b/121477739-791686966519154943/ep.animated.3_362.jpg")',
